...
describe('Testing /GET businesses/:businessId', function () {
        ...
        it('it should GET a business in the array by businessId.', function (done) {
...
describe('Testing /POST businesses', function () {
        ...
        it('checking to see if two businesses are available in the database', function (done) {
...
describe('Testing /FILTER by category endpoint', function () {

        it('it should filter business search by a particular category', function (done) {

                _chai2.default.request(_app2.default).get('/api/v1/businesses/?category=Flight').end(function (err, res) {
                        ...
                        res.body.searchBusinessResults[0].should.have.property('businessAddress').eql('No 10 New kingston road new zealand');
...
describe('Testing /FILTER by location endpoint', function () {
        ...
        it('it should filter business search by a particular location', function (done) {

                _chai2.default.request(_app2.default).get('/api/v1/businesses/?location=Austrailia').end(function (err, res) {
...
describe('Testing /FILTER by Category endpoint', function () {
        ...
        it('it should return an error message if business under category doesnt exist', function (done) {

                _chai2.default.request(_app2.default).get('/api/v1/businesses/?category=recreation').end(function (err, res) {
...
describe('Testing API endpoints', function () {
        ...
        describe('Testing /DELETE businesses/:businessId', function () {
                ...
                it('it should  return a message that business does not exist', function (done) {
