...
var ReviewController = function () {
    ...
    _createClass(ReviewController, null, [{
        ...
        value: function addReview(req, res) {
            ...
            return res.status(201).json({ message: 'review was added successfully', review: review });
        }
        ...
        value: function getAllReviews(req, res) {
            ...
            return res.json({ message: 'reviews loaded successfully', allReviews: allReviews });
        }
    }]);
